...
def create_crew():
    """Cria e retorna o crew configurado."""
    try:
        ...
        fallback_agent = Agent(
            role="Assistente de Fallback",
            goal="Manter a aplicação funcionando",
        ...
        fallback_task = Task(
            description="Executar em modo de segurança",
            expected_output="Aplicação rodando em modo seguro",
...
# Criar crew global para exportação
crew = create_crew()
